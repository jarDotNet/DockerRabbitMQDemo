...
using OrderApi.Application.v1.Services;
using OrderApi.Domain.Entities;
using OrderApi.Infrastructure.Data.Database;
using OrderApi.Infrastructure.Data.Repository.v1;
using OrderApi.Infrastructure.Messaging.Receive.Options.v1;
using OrderApi.Infrastructure.Messaging.Receive.Receiver.v1;
...
namespace OrderApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRequestHandler<GetPaidOrderQuery, IEnumerable<Order>>, GetPaidOrderQueryHandler>();
            services.AddTransient<IRequestHandler<GetOrderByIdQuery, Order>, GetOrderByIdQueryHandler>();
            services.AddTransient<IRequestHandler<GetOrderByCustomerGuidQuery, IEnumerable<Order>>, GetOrderByCustomerGuidQueryHandler>();
